<template>
  <nav class="navbar flex w-full fixed top-0 start-0 z-50 bg-white border-b border-solid border-gray-200 dark:bg-gray-900">
    <div class="flex flex-wrap items-center justify-between w-full gap-x-2 xs:gap-x-5">
      <div class="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <NuxtLink to="/">
          <img
            ...
            alt="Logo"
            class="w-[130px] cursor-pointer navbar-logo"
          >
        </NuxtLink>
      </div>
      <div class="navbar-breadcrumb hidden lg:flex">
        <Breadcrumb />
      </div>
      <div class="navbar-input hidden md:flex">
        <SearchInput />
      </div>
      <div
