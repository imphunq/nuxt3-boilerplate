<template>
  <div class="px-2 py-[10px] w-20 flex items-center border border-solid border-gray-200 rounded-lg">
    <div class="w-1/2 cursor-pointer flex items-center justify-center">
