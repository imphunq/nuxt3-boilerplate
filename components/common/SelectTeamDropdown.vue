<template>
  <div>
    ...
    >
      <svg class="mr-3" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" id="user" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><g><path fill="none" d="M0 0h24v24H0z"></path><path d="M20 22h-2v-2a3 3 0 0 0-3-3H9a3 3 0 0 0-3 3v2H4v-2a5 5 0 0 1 5-5h6a5 5 0 0 1 5 5v2zm-8-9a6 6 0 1 1 0-12 6 6 0 0 1 0 12zm0-2a4 4 0 1 0 0-8 4 4 0 0 0 0 8z"></path></g></svg>
      <span class="flex-1 mr-5">
        Team: HostDesign Team
      </span>
    ...
    <!-- Dropdown menu -->
    <div id="dropdown-select-team" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
