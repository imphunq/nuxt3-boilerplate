<template>
  ...
  <div class="flex flex-col justify-between rounded-lg bg-white shadow-lg p-4 h-96">
    <div class="h-5/6 relative mb-3">
      <div class="bg-red-100 h-4/5 absolute inset-10 bg-cover bg-center z-0">
      </div>

      <div class="rounded-lg opacity-0 hover:opacity-100 hover:bg-slate-300 duration-300 absolute inset-0 z-10">
        <div class="w-full h-full">
          <div class="flex justify-end m-4 cursor-pointer">
            <svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="1"></circle><circle cx="19" cy="12" r="1"></circle><circle cx="5" cy="12" r="1"></circle></svg>
          </div>
          <div class="h-2/3 z-20 flex justify-center items-center text-6xl text-white">
            <button type="button" class="px-5 py-3 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none outline-none focus:ring-blue-300 font-medium rounded-full text-sm text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">View</button>
          </div>
          <div class="m-4 flex items-center space-x-3 cursor-pointer text-sm">
    ...
    <div class="flex items-center justify-between">
      <div class="project-info">
        <div class="text-sm font-semibold mb-1">new project</div>
